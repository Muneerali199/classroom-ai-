-- ✅ CORRECTED Migration: Create comprehensive timetable system
-- Fixed type mismatch: subject_id is now INTEGER to match subjects table
...
BEGIN
    ...
    RAISE NOTICE '✅ Fixed: subject_id and room_id are now INTEGER to match existing tables';
END $$;
