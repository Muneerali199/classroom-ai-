    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="max-w-3xl mx-auto p-6 rounded-3xl"
            style={{
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              {benefits.map((benefit, index) => (
                ...
                >
                  ...
                  <h4 className="font-bold text-gray-700 mb-2">{benefit.title}</h4>
                ...
                {stats.map((stat, index) => (
                  <motion.div
                    ...
                    style={{
                      ...
                      boxShadow: 'inset 4px 4px 8px #c0c0c0, inset -4px -4px 8px #ffffff'
                    }}
                  >
