...
import { 
  Home, User, BookOpen, BarChart3, Hash, Bot, Calendar,
  Video, FileText, LogOut, Sparkles
} from 'lucide-react';
...
const menuItems = [
  {
    ...
    items: [
      ...
      { href: '/student/pin-attendance', label: 'markAttendance', icon: Hash },
      { href: '/student/attendance', label: 'myAttendance', icon: BarChart3 },
    ]
  },
  {
    title: 'Academic',
    items: [
      { href: '/student/students', label: 'myCourses', icon: BookOpen },
  ...
  },
  {
    title: 'Tools',
    items: [
      { href: '/student/assistant', label: 'assistant', icon: Bot },
      { href: '/student/profile', label: 'profile', icon: User },
    ]
  }
];

export default function UltraModernStudentSidebar() {
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <svg viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
              ...
              <circle cx="100" cy="100" r="95" fill="url(#sidebarLogoGradient)" opacity="0.15" />
              <g filter="url(#sidebarGlow)">
                <path d="M 60 50 L 140 50 L 140 150 L 100 140 L 60 150 Z" fill="url(#sidebarLogoGradient)" opacity="0.9" />
          ...
          {state === 'expanded' && (
            ...
            >
              ...
              <span className="text-xs text-gray-400 font-medium">Student Portal</span>
            </motion.div>
          )}
        </div>
      </SidebarHeader>
