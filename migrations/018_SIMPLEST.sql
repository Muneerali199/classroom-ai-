-- Migration: Simplest meetings table (NO UUID comparisons)
...
-- RLS Policies using helper functions (from migration 017)
...
DO $$
BEGIN
    RAISE NOTICE '✅ Meetings system created (SIMPLEST VERSION)!';
    RAISE NOTICE '📅 Tables created with subject support';
    RAISE NOTICE '🔒 RLS enabled using helper functions';
