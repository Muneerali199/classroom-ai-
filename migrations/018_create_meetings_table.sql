-- Migration: Create meetings table with proper RLS
-- This creates a comprehensive meetings system for teachers and students
...
-- Add comments
COMMENT ON TABLE public.meetings IS 'Stores all meeting/class schedules';
...
COMMENT ON VIEW public.upcoming_meetings IS 'Shows all upcoming scheduled meetings';
COMMENT ON VIEW public.teacher_meetings_view IS 'Teacher view with participant counts';

-- Verification
DO $$
BEGIN
    RAISE NOTICE '✅ Meetings system migration complete!';
    RAISE NOTICE '📅 Tables created: meetings, meeting_participants, meeting_attachments';
    ...
    RAISE NOTICE '✅ Teachers can now create and manage meetings!';
