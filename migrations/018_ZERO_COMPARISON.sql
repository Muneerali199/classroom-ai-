-- Migration: ZERO COMPARISON meetings (uses functions from 017)
-- Run this AFTER running 017_ZERO_COMPARISON.sql
...
BEGIN
    RAISE NOTICE '========================================';
    RAISE NOTICE '✅ MEETINGS CREATED (ZERO COMPARISON)!';
    RAISE NOTICE '========================================';
    RAISE NOTICE '';
    RAISE NOTICE '📅 Tables: meetings, participants, attachments';
    RAISE NOTICE '🔒 RLS policies applied (10 policies)';
    RAISE NOTICE '📊 Views created with subject support';
    RAISE NOTICE '';
    RAISE NOTICE '✅ Uses functions from migration 017!';
    RAISE NOTICE '🎉 Ready to create meetings!';
    RAISE NOTICE '========================================';
END $$;
